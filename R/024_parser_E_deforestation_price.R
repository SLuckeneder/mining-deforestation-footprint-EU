...
file_E <- "extension_forest_loss_price_allocation.csv"
...
for(yr in years){
  ...
  if(! file.exists(file.path(path_parsed, "extensions", paste0("e_forest_loss_price_", yr, ".RData")))){
    ...
    save(e, file = file.path(path_parsed, paste0("e_forest_loss_price_", yr, ".RData")))
